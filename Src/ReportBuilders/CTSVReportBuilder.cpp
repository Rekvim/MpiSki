    ...
    )
{
    ...
    // report.data.push_back({"Отчет ЦТ", 67, 8, safeToString(telemetry.???)});
    // report.data.push_back({"Отчет ЦТ", 68, 8, safeToString(telemetry.???)});
    // report.data.push_back({"Отчет ЦТ", 69, 8, safeToString(telemetry.???)});
    // report.data.push_back({"Отчет ЦТ", 70, 8, safeToString(telemetry.???)});
    // report.data.push_back({"Отчет ЦТ", 71, 8, safeToString(telemetry.???)});
    // report.data.push_back({"Отчет ЦТ", 72, 8, safeToString(telemetry.???)});
