    ...
    )
{
    ...
    report.data.push_back({"Отчет", 10, 13, safeToString(telemetry.supplyPressure)});
    ...
    report.data.push_back({"Отчет", 20, 5, safeToString(telemetry.dinamicReal)});
    report.data.push_back({"Отчет", 20, 8, safeToString(telemetry.dinamicRecomend)});

    report.data.push_back({"Отчет", 22, 5, safeToString(telemetry.dinamicIpReal)});
    report.data.push_back({"Отчет", 22, 8, safeToString(telemetry.dinamicIpRecomend)});

    report.data.push_back({"Отчет", 24, 5, safeToString(telemetry.strokeReal)});
    report.data.push_back({"Отчет", 24, 8, safeToString(telemetry.strokeRecomend)});

    report.data.push_back({"Отчет", 26, 5, safeToString(telemetry.rangeReal)});
    report.data.push_back({"Отчет", 26, 8, safeToString(telemetry.rangeRecomend)});

    report.data.push_back({"Отчет", 28, 5, safeToString(telemetry.rangePressure)});

    report.data.push_back({"Отчет", 30, 5, safeToString(telemetry.frictionPercent)});

    report.data.push_back({"Отчет", 32, 5, safeToString(telemetry.friction)});

    report.data.push_back({"Отчет", 46, 5, safeToString(telemetry.strokeTest_timeForward)});
    report.data.push_back({"Отчет", 46, 8, safeToString(telemetry.strokeTest_timeBackward)});
