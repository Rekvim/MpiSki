#include "CyclicShutoffAnalyzer.h"

void CyclicShutoffAnalyzer::configure(int cycles, int doCount)
{
    m_cycles = cycles;
...
void CyclicShutoffAnalyzer::start()
{
    m_switch3to0 = 0;
    m_switch0to3 = 0;
...
void CyclicShutoffAnalyzer::onSample(const Sample& s)
{
...
void CyclicShutoffAnalyzer::finish()
{
...
const CyclicShutoffResult&
CyclicShutoffAnalyzer::result() const
{
    return m_result;
}