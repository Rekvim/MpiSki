...
Algorithm::Algorithm(QObject *parent, bool endTestAfterProcess)
    : Test(parent)
...
Algorithm::calculateRegression(const QVector<QPointF> &points, Limits limits)
{
...
qreal
Algorithm::linearityError(const QVector<QPointF>& points,
...
Algorithm::Limits
Algorithm::limits(const QVector<QPointF> &points1,
...
QVector<QPointF>
Algorithm::regressionPoints(Regression regression, Limits limits)
{
...
QVector<QPointF>
Algorithm::frictionPoints(const QVector<QPointF> &pointsForward,
...
QPair<qreal, qreal>
Algorithm::meanMax(const QVector<QPointF> &pointsForward,
                   const QVector<QPointF> &pointsBackward)
{
...
QPair<qreal, qreal>
Algorithm::rangeLimits(Regression regression1,
...
QPair<qreal, qreal>
Algorithm::springLimits(Regression regression1,
                        Regression regression2,
                        Limits limits)
{
    auto x_val = [](Regression regression, qreal y) { return (y - regression.b) / regression.k; };
